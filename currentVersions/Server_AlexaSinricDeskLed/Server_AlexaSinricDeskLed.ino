...
Filename:     Server_AlexaSinricDeskLed.ino
...
Function:     DeskLED handles the LED string on the desk. It receive comands from
...
//pins
#define RED_PIN 3      //TXD
#define BLUE_PIN 2     //GPIO2
#define GREEN_PIN 0    //GPIO0
#define RELAY 1        //RX (check)

//maximal color output
#define MAX_RED 255   //maximal analog RED_PIN output255
#define MAX_GREEN 100  //maximal analog GREEN_PIN output 60 // rgb=255 doesn´t look white
#define MAX_BLUE 150  //maximal analog BLUE_PIN output 100
